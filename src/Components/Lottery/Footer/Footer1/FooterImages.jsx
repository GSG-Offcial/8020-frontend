    ...
    <div className={styles.FooterImages_mainDiv}>
      ...
      <div>
        <ul class={`nav justify-content-center ${styles.Footer_images_SM}`}>
          ...
          <li class="nav-item">
            <a class="nav-link" href="#"><img src={telegram} alt="" /></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#"><img src={instragram} alt="" /></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#"><img src={facebook} alt="" /></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#"><img src={twitter} alt="" /></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#"><img src={github} alt="" /></a>
          </li>
