...
export const LotDesclaimer = () => {
    return (
        <div className={`mt-5 mb-5 ${styles.LotDesclaimer_mainDiv}`}>
            ...
            <h1 className={`text-center ${styles.LotDesclaimer_Heading1}`}>DISCLAIMER</h1>
            {/* </div> */}
            <div className={styles.desc_content}>
                ...
                Contract. For more information please read the disclaimer.
                 ...
                 <button type="button" className={`btn  btn-lg text-white mt-3 ${styles.lot_descbutton}`}>DESCLAMIER</button>
                 </div>
            </div>
        </div>
    )
