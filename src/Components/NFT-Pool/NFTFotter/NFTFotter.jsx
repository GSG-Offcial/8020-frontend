...
import styles from './NFTFotter.module.css'
...
export const NFTFotter = () => {
    return (
        <div className={` ${styles.NFTFotter_mainDiv}`}>
            <div className={`text-white`}>
        <ul class={`nav justify-content-center fs-4 ${styles.Footer_li}`}>
          <li class="nav-item ">
      ...
      <div>
        <ul class={`nav justify-content-center ${styles.Footer_images_SMNFT}`}>
          <li class="nav-item">
