        ...
        <div className={`d-flex align-items-center mt-3 ${styles.G50DropLottery_mainDiv}`}>
            <div className={`container-fluid`}>
                <div className={`col-10 mx-auto`}>
                    <div className={`row`}>
                        <div className={`col-lg-6 pt-5 order-lg-1 ${styles.G50DropLottery_image}`}>
                            <img src={GS50DropLottery} alt="" />
                        </div>
                        <div className={`col-lg-6 order-lg-2 pt-5 pt-lg-0 text-white d-flex justify-content-center flex-column ${styles.G50DropLottery_Div2}`}>
