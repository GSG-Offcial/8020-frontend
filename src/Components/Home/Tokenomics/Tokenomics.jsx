            ...
            >
              ...
              <ul className={`text-white`}>
                <li>
                  ...
                  80% of every GS50 purchase is locked in the smart contract to
                  provide liquidity for GS50 tokens. 20% of the purchase is used
                  to operate the economy for holders, stakers, developers, and
                  creators.
                </li>
                <li>
                  <i class={`fas fa-star ${styles.Tokenomics_starLOGO}`}></i>
                  GS50 tokens can be sold back to the smart contract in exchange
                  for ETH, BSC, or MATIC.
                </li>
                <li>
                  <i class={`fas fa-star ${styles.Tokenomics_starLOGO}`}></i>
                  GS50 tokens can be used to buy NFT's, play games, and gift to
                  others.
                </li>
              </ul>
            </div>
