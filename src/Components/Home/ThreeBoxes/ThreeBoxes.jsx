    ...
    <div className={`container`}>
      ...
      >
        ...
        <div class="col pt-md-4">
          ...
          <p className={`px-3 pt-2 fw-lighter`}>
            NFT drops from professional Video, Graphic, and Photographic
            creators
          </p>
        </div>
        <div class="col pt-md-4">
          <span className={`px-3  fs-5 fw-bolder`}>
