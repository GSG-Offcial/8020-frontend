            ...
            >
              ...
              <p className={`px-4 py-3 ${styles.NFTRewardPool_para}`}>
                <span className={`fw-light`}>
                  The NFT Pool takes in 3% of all GS50 sales. Holders of the GSG
                  Access Token can stake their NFT to receive rewards from this
                  pool. There are only 500 NFT's available to be staked in this
                  pool. Once the NFT's are gone you will have to buy them in the
                  open market.
                </span>
              </p>
            </div>
