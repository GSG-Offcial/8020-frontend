            ...
            <div className={`container-fluid`}>
                {/* <div className={`row`}> */}
                    <div className={`col-10 mx-auto  ${styles.NFTRewardPool}`}>
                        <div className={`row`}>
                            <div data-aos="fade-right" className={`col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex justify-content-center flex-column ${styles.NFTRewardPool_FirstDiv}`}>
                            ...
                            <div className={`col-lg-6 order-1 order-lg-2 ${styles.NFTRewardPool_Image}`} data-aos="fade-left">
